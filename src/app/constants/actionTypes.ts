...
export const GET_MODULE_IDENTITY_TWIN = 'GET_MODULE_IDENTITY_TWIN';
export const GET_MODULE_IDENTITY = 'GET_MODULE_IDENTITY';
export const DELETE_MODULE_IDENTITY = 'DELETE_MODULE_IDENTITY';
